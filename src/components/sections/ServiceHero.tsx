    ...
    >
      ...
      <div className="relative mx-auto flex w-full max-w-[1056px] flex-col items-center gap-8 text-center md:gap-6 3xl:max-w-[1200px]">
        ...
        <p
          ...
          // note). In the tablet band the paragraph gets the desktop cap and a size that tracks the
          // viewport, so the ratio that gives desktop its three lines — 880 of copy at 28px — holds
          // from 600px up to the md switch.
